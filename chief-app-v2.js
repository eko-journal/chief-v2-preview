...
function renderPageAnimation(type) {
  ...
  if (t === 'signal-flow') {
    ...
    var uCss = '<style>'
      ...
      + '.ua-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none;gap:14px;padding:16px 0 44px}'
      ...
      + '.ua-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:8px;width:260px}'
      + '.ua-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:9px;padding:10px 12px}'
      ...
      + '.ua-kval{font-size:20px;font-weight:700;letter-spacing:-1px;color:#141413;font-family:Space Grotesk,system-ui}'
    ...
    var uC = '<svg viewBox="0 0 140 140" width="28" height="28" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg>';
    ...
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.hs-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.hs-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.hs-s0{animation:hs0 10s linear infinite}.hs-s1{animation:hs1 10s linear infinite}.hs-s2{animation:hs2 10s linear infinite}.hs-s3{animation:hs3 10s linear infinite}.hs-s4{animation:hs4 10s linear infinite}@keyframes hs0{0%,0.5%{opacity:0}3%,17%{opacity:1}20%,100%{opacity:0}}@keyframes hs1{0%,20%{opacity:0}23%,37%{opacity:1}40%,100%{opacity:0}}@keyframes hs2{0%,40%{opacity:0}43%,57%{opacity:1}60%,100%{opacity:0}}@keyframes hs3{0%,60%{opacity:0}63%,72%{opacity:1}75%,100%{opacity:0}}@keyframes hs4{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.hs-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.hs-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600}.hs-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.hs-channels{display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:center;max-width:300px}.hs-ch{font-family:JetBrains Mono,monospace;font-size:11px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:6px;padding:8px 14px;color:#6E665A}.hs-chief{width:70px;height:70px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:12px auto 0}.hs-iemri{background:#FAF9F5;border:1px solid #DED9CC;border-radius:14px;padding:18px 26px;min-width:220px}.hs-iemri-title{font-size:15px;font-weight:600;color:#141413;margin-bottom:8px}.hs-iemri-row{display:flex;justify-content:space-between;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195;margin-bottom:5px}.hs-iemri-val{color:#6E665A;font-weight:500}.hs-sla-bar{height:3px;background:#E9E5D9;border-radius:2px;margin-top:8px;overflow:hidden}.hs-sla-fill{height:100%;width:0;background:linear-gradient(90deg,#D97757,#EBC3B0);border-radius:2px;animation:hs-sla 10s linear infinite}@keyframes hs-sla{0%,20%{width:0}37%{width:72%}40%,100%{width:0}}.hs-map{width:220px;height:120px;background:#F0EDE4;border-radius:10px;border:1px solid #DED9CC;position:relative;overflow:hidden}.hs-dot{position:absolute;width:10px;height:10px;border-radius:50%;background:#D97757;box-shadow:0 0 0 4px rgba(217,119,87,.2);animation:hs-dotpulse 1.5s ease-in-out infinite}.hs-dot1{top:30%;left:25%}.hs-dot2{top:55%;left:60%}.hs-dot3{top:20%;right:20%}@keyframes hs-dotpulse{0%,100%{box-shadow:0 0 0 4px rgba(217,119,87,.2)}50%{box-shadow:0 0 0 8px rgba(217,119,87,.1)}}.hs-assign{font-family:JetBrains Mono,monospace;font-size:8.5px;background:#F6E4DA;border:1px solid #D97757;border-radius:5px;padding:3px 9px;color:#D97757;margin-top:8px}.hs-checks{display:flex;flex-direction:column;gap:8px;min-width:200px}.hs-ck{display:flex;align-items:center;gap:8px;font-family:JetBrains Mono,monospace;font-size:9px;color:#6E665A}.hs-ck-icon{width:20px;height:20px;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0}.hs-ck-ok{background:#E7EADE;animation:hs-ckpop .4s ease forwards}.hs-ck-w{background:#F0EDE4}.hs-ck1{animation-delay:.2s}.hs-ck2{animation-delay:.5s}.hs-ck3{animation-delay:.8s}@keyframes hs-ckpop{from{transform:scale(0.5)}to{transform:scale(1)}}.hs-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.hs-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.hs-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.hs-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}.hs-kbar{height:3px;border-radius:2px;margin-top:4px}' + '</style>' + '<div class="hs-wrap"><div class="hs-stage hs-s0"><div class="hs-channels"><div class="hs-ch">📞 Çağrı</div><div class="hs-ch">📱 WhatsApp</div><div class="hs-ch">📋 Form</div><div class="hs-ch">🔧 IoT</div></div><div class="hs-chief"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div><div class="hs-cap"><b>Saha sinyalleri iş emrine dönüşüyor</b></div></div><div class="hs-stage hs-s1"><div class="hs-iemri"><div class="hs-iemri-title">İş Emri #4821</div><div class="hs-iemri-row"><span>Ekip</span><span class="hs-iemri-val">Saha A — Teknisyen 3</span></div><div class="hs-iemri-row"><span>Lokasyon</span><span class="hs-iemri-val">Bölge 7 / İstanbul</span></div><div class="hs-iemri-row"><span>SLA</span><span class="hs-iemri-val">4 saat</span></div><div class="hs-sla-bar"><div class="hs-sla-fill"></div></div></div><div class="hs-cap"><span class="hs-badge">1</span><b>İş emri ve saha planlama</b></div></div><div class="hs-stage hs-s2"><div class="hs-map"><div class="hs-dot hs-dot1"></div><div class="hs-dot hs-dot2"></div><div class="hs-dot hs-dot3"></div></div><div class="hs-assign">CHIEF — En yakın ekip atandı</div><div class="hs-cap"><span class="hs-badge">2</span><b>Rota ve ekip optimizasyonu</b></div></div><div class="hs-stage hs-s3"><div class="hs-checks"><div class="hs-ck"><div class="hs-ck-icon hs-ck-ok hs-ck1"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg></div>Fotoğraf yüklendi</div><div class="hs-ck"><div class="hs-ck-icon hs-ck-ok hs-ck2"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg></div>Müşteri imzası alındı</div><div class="hs-ck"><div class="hs-ck-icon hs-ck-ok hs-ck3"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg></div>Kapanış belgesi oluştu</div></div><div class="hs-cap"><span class="hs-badge">3</span><b>Kanıtlı kapanış</b></div></div><div class="hs-stage hs-s4"><div class="hs-kgrid"><div class="hs-kpi"><span class="hs-klabel">SLA Uyumu</span><div class="hs-kval">96%</div><div class="hs-kbar" style="background:linear-gradient(90deg,#788C5D,#A5B888)"></div></div><div class="hs-kpi"><span class="hs-klabel">İlk Seferde</span><div class="hs-kval">88%</div><div class="hs-kbar" style="background:linear-gradient(90deg,#6A9BCC,#9DC0E8)"></div></div><div class="hs-kpi"><span class="hs-klabel">Açık İş</span><div class="hs-kval">34</div><div class="hs-kbar" style="background:linear-gradient(90deg,#D97757,#EBC3B0)"></div></div><div class="hs-kpi"><span class="hs-klabel">Ort. Müdahale</span><div class="hs-kval">2.4s</div><div class="hs-kbar" style="background:linear-gradient(90deg,#141413,#6E665A)"></div></div></div><div class="hs-cap"><b>Saha operasyonlarında tam görünürlük</b></div></div></div>' + '</div>';

  } else if (t === 'perakende-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.pr-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.pr-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.pr-s0{animation:pr0 10s linear infinite}.pr-s1{animation:pr1 10s linear infinite}.pr-s2{animation:pr2 10s linear infinite}.pr-s3{animation:pr3 10s linear infinite}.pr-s4{animation:pr4 10s linear infinite}@keyframes pr0{0%,0.5%{opacity:0}3%,17%{opacity:1}20%,100%{opacity:0}}@keyframes pr1{0%,20%{opacity:0}23%,37%{opacity:1}40%,100%{opacity:0}}@keyframes pr2{0%,40%{opacity:0}43%,57%{opacity:1}60%,100%{opacity:0}}@keyframes pr3{0%,60%{opacity:0}63%,72%{opacity:1}75%,100%{opacity:0}}@keyframes pr4{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.pr-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.pr-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600}.pr-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.pr-flow{display:flex;align-items:center;gap:8px}.pr-node{font-family:JetBrains Mono,monospace;font-size:11px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:7px;padding:10px 16px;color:#6E665A;text-align:center}.pr-arrow{color:#DED9CC;font-size:24px}.pr-chief{width:40px;height:40px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center}.pr-stock{display:flex;flex-direction:column;gap:6px;width:220px}.pr-srow{display:flex;align-items:center;gap:8px}.pr-sbar{flex:1;height:8px;background:#E9E5D9;border-radius:4px;overflow:hidden}.pr-sfill{height:100%;border-radius:4px}.pr-slow{background:linear-gradient(90deg,#D97757,#EBC3B0);animation:pr-slow 10s linear infinite}@keyframes pr-slow{0%,20%{width:20%}37%{width:20%}40%,100%{width:20%}}.pr-sok{background:linear-gradient(90deg,#788C5D,#A5B888)}.pr-slabel{font-family:JetBrains Mono,monospace;font-size:8px;color:#A9A195;width:50px}.pr-swarn{font-family:JetBrains Mono,monospace;font-size:8.5px;background:#F6E4DA;border:1px solid #D97757;border-radius:5px;padding:3px 9px;color:#D97757;margin-top:4px}.pr-chain{display:flex;align-items:center;gap:6px}.pr-cnode{display:flex;flex-direction:column;align-items:center;gap:4px}.pr-cico{width:38px;height:38px;border-radius:10px;display:flex;align-items:center;justify-content:center}.pr-cico-ok{background:#E7EADE;border:1px solid #788C5D}.pr-cico-act{background:#F6E4DA;border:1.5px solid #D97757;animation:pr-act 1s ease-in-out infinite}@keyframes pr-act{0%,100%{box-shadow:0 0 0 0 rgba(217,119,87,.3)}50%{box-shadow:0 0 0 6px rgba(217,119,87,.1)}}.pr-clabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195}.pr-carr{font-size:16px;color:#DED9CC;margin-top:-12px}.pr-metrics{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.pr-met{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.pr-mlabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.pr-mval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}' + '</style>' + '<div class="pr-wrap"><div class="pr-stage pr-s0"><div class="pr-flow"><div class="pr-node">Mağaza<br>Talebi</div><div class="pr-arrow">→</div><div class="pr-chief"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div><div class="pr-arrow">→</div><div class="pr-node">Depo +<br>Tedarik</div></div><div class="pr-cap"><b>Satıştan teslikata tek akış</b></div></div><div class="pr-stage pr-s1"><div class="pr-stock"><div class="pr-srow"><span class="pr-slabel">Ürün A</span><div class="pr-sbar"><div class="pr-sfill pr-slow" style="width:18%"></div></div></div><div class="pr-srow"><span class="pr-slabel">Ürün B</span><div class="pr-sbar"><div class="pr-sfill pr-sok" style="width:72%"></div></div></div><div class="pr-srow"><span class="pr-slabel">Ürün C</span><div class="pr-sbar"><div class="pr-sfill pr-sok" style="width:58%"></div></div></div><div class="pr-swarn">CHIEF — Ürün A kritik seviyede</div></div><div class="pr-cap"><span class="pr-badge">1</span><b>Stok ve tedarik aksiyonu</b></div></div><div class="pr-stage pr-s2"><div class="pr-chain"><div class="pr-cnode"><div class="pr-cico pr-cico-ok"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-4 0v2M8 11h8"/></svg></div><span class="pr-clabel">Sipariş</span></div><div class="pr-carr">→</div><div class="pr-cnode"><div class="pr-cico pr-cico-ok"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg></div><span class="pr-clabel">Sevkiyat</span></div><div class="pr-carr">→</div><div class="pr-cnode"><div class="pr-cico pr-cico-act"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#D97757" stroke-width="2"><path d="M20 10c0 6-8 12-8 12S4 16 4 10a8 8 0 0 1 16 0z"/><circle cx="12" cy="10" r="3"/></svg></div><span class="pr-clabel">Teslimat</span></div></div><div class="pr-cap"><span class="pr-badge">2</span><b>Saha ve teslimat görünürlüğü</b></div></div><div class="pr-stage pr-s3"><div class="pr-metrics"><div class="pr-met"><span class="pr-mlabel">Stok Doğruluğu</span><div class="pr-mval">98%</div></div><div class="pr-met"><span class="pr-mlabel">Teslimat SLA</span><div class="pr-mval">94%</div></div><div class="pr-met"><span class="pr-mlabel">Açık Sipariş</span><div class="pr-mval">312</div></div><div class="pr-met"><span class="pr-mlabel">İade Oranı</span><div class="pr-mval">1.8%</div></div></div><div class="pr-cap"><b>Perakende operasyonlarında tek görünürlük</b></div></div></div>' + '</div>';

  } else if (t === 'kamu-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.km-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.km-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.km-s0{animation:km0 10s linear infinite}.km-s1{animation:km1 10s linear infinite}.km-s2{animation:km2 10s linear infinite}.km-s3{animation:km3 10s linear infinite}@keyframes km0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes km1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes km2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes km3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.km-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.km-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600}.km-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.km-req{background:#F0EDE4;border:1px solid #DED9CC;border-radius:12px;padding:18px 24px;min-width:240px}.km-req-icon{font-size:24px;text-align:center;margin-bottom:6px}.km-req-title{font-size:15px;font-weight:600;color:#141413;margin-bottom:4px;text-align:center}.km-req-sub{font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195;text-align:center}.km-chief-row{display:flex;align-items:center;gap:8px;margin-top:10px;justify-content:center}.km-mini-chief{width:28px;height:28px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center}.km-chief-label{font-family:JetBrains Mono,monospace;font-size:8px;color:#D97757}.km-units{display:flex;flex-direction:column;gap:6px;width:240px}.km-unit{display:flex;align-items:center;gap:8px;font-family:JetBrains Mono,monospace;font-size:9px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:6px;padding:6px 10px;color:#6E665A}.km-unit-active{background:#E2EAF2;border-color:#6A9BCC;color:#2C5F8A;animation:km-ua 1s ease-in-out infinite}@keyframes km-ua{0%,100%{box-shadow:0 0 0 0 rgba(106,155,204,.2)}50%{box-shadow:0 0 0 4px rgba(106,155,204,.1)}}.km-task{background:#FAF9F5;border:1px solid #DED9CC;border-radius:10px;padding:12px 16px;min-width:210px}.km-task-head{font-family:JetBrains Mono,monospace;font-size:8px;color:#D97757;margin-bottom:6px}.km-task-title{font-size:12px;font-weight:600;color:#141413;margin-bottom:8px}.km-task-row{display:flex;justify-content:space-between;font-family:JetBrains Mono,monospace;font-size:8px;color:#A9A195;margin-bottom:4px}.km-task-val{color:#6E665A}.km-prog{height:3px;background:#E9E5D9;border-radius:2px;margin-top:6px;overflow:hidden}.km-prog-fill{height:100%;width:0;background:linear-gradient(90deg,#6A9BCC,#9DC0E8);animation:km-prog 10s linear infinite}@keyframes km-prog{0%,50%{width:0}75%{width:65%}100%{width:0}}.km-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.km-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.km-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.km-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}' + '</style>' + '<div class="km-wrap"><div class="km-stage km-s0"><div class="km-req"><div class="km-req-icon">🏛️</div><div class="km-req-title">Yeni Vatandaş Başvurusu</div><div class="km-req-sub">Park bakım talebi — Şikayet</div><div class="km-chief-row"><div class="km-mini-chief"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div><span class="km-chief-label">CHIEF sınıflandırıyor...</span></div></div><div class="km-cap"><b>Vatandaş talebi otomatik sınıflandırıldı</b></div></div><div class="km-stage km-s1"><div class="km-units"><div class="km-unit">🏢 Planlama Birimi</div><div class="km-unit km-unit-active">🌳 Park ve Bahçeler ← Atandı</div><div class="km-unit">🚧 Teknik İşler</div></div><div class="km-cap"><span class="km-badge">1</span><b>İlgili birime otomatik yönlendirme</b></div></div><div class="km-stage km-s2"><div class="km-task"><div class="km-task-head">GÖREV #8821</div><div class="km-task-title">Park Bakım Talebi</div><div class="km-task-row"><span>Sorumlu</span><span class="km-task-val">Bakım Ekibi B</span></div><div class="km-task-row"><span>Süre</span><span class="km-task-val">3 iş günü</span></div><div class="km-prog"><div class="km-prog-fill"></div></div></div><div class="km-cap"><span class="km-badge">2</span><b>Görev ve SLA takibi</b></div></div><div class="km-stage km-s3"><div class="km-kgrid"><div class="km-kpi"><span class="km-klabel">Kapanış Süresi</span><div class="km-kval">2.8g</div></div><div class="km-kpi"><span class="km-klabel">Vatandaş Mem.</span><div class="km-kval">87%</div></div><div class="km-kpi"><span class="km-klabel">Açık Başvuru</span><div class="km-kval">143</div></div><div class="km-kpi"><span class="km-klabel">SLA Uyumu</span><div class="km-kval">92%</div></div></div><div class="km-cap"><b>Kamu hizmetlerinde şeffaf takip</b></div></div></div>' + '</div>';

  } else if (t === 'kurumsal-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.kh-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.kh-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.kh-s0{animation:kh0 10s linear infinite}.kh-s1{animation:kh1 10s linear infinite}.kh-s2{animation:kh2 10s linear infinite}.kh-s3{animation:kh3 10s linear infinite}@keyframes kh0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes kh1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes kh2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes kh3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.kh-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.kh-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600}.kh-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.kh-timeline{display:flex;align-items:center;gap:0;width:300px}.kh-step{display:flex;flex-direction:column;align-items:center;gap:5px;flex:1}.kh-dot{width:14px;height:14px;border-radius:50%;position:relative}.kh-done{background:#788C5D}.kh-active{background:#D97757;animation:kh-ap .8s ease-in-out infinite}@keyframes kh-ap{0%,100%{box-shadow:0 0 0 0 rgba(217,119,87,.3)}50%{box-shadow:0 0 0 5px rgba(217,119,87,.1)}}.kh-pending{background:#E9E5D9}.kh-line{height:2px;flex:1;margin-top:5px}.kh-line-done{background:#788C5D}.kh-line-dash{background:repeating-linear-gradient(90deg,#DED9CC 0,#DED9CC 3px,transparent 3px,transparent 6px)}.kh-slabel{font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195;text-align:center}.kh-approval{display:flex;flex-direction:column;gap:6px;width:230px}.kh-arow{display:flex;align-items:center;gap:8px;font-family:JetBrains Mono,monospace;font-size:9px;padding:6px 10px;border-radius:6px}.kh-app{background:#E7EADE;border:1px solid #788C5D;color:#5F7049}.kh-apen{background:#F6E4DA;border:1px solid #D97757;color:#A05A2C;animation:kh-pen .8s ease-in-out infinite}@keyframes kh-pen{0%,100%{box-shadow:none}50%{box-shadow:0 0 8px rgba(217,119,87,.2)}}.kh-awt{background:#F0EDE4;border:1px solid #DED9CC;color:#A9A195}.kh-resources{display:grid;grid-template-columns:1fr 1fr;gap:8px;width:240px}.kh-res{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:8px;padding:8px 10px}.kh-rname{font-family:JetBrains Mono,monospace;font-size:8px;color:#A9A195;display:block;margin-bottom:3px}.kh-rbar{height:4px;background:#E9E5D9;border-radius:2px;overflow:hidden}.kh-rfill{height:100%;border-radius:2px}.kh-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.kh-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.kh-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.kh-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}' + '</style>' + '<div class="kh-wrap"><div class="kh-stage kh-s0"><div class="kh-timeline"><div class="kh-step"><div class="kh-dot kh-done"></div><span class="kh-slabel">Talep</span></div><div class="kh-line kh-line-done"></div><div class="kh-step"><div class="kh-dot kh-done"></div><span class="kh-slabel">Analiz</span></div><div class="kh-line kh-line-done"></div><div class="kh-step"><div class="kh-dot kh-active"></div><span class="kh-slabel">Onay</span></div><div class="kh-line kh-line-dash"></div><div class="kh-step"><div class="kh-dot kh-pending"></div><span class="kh-slabel">Teslimat</span></div></div><div class="kh-cap"><b>Proje ve müşteri süreci tek akışta</b></div></div><div class="kh-stage kh-s1"><div class="kh-approval"><div class="kh-arow kh-app">✓ Proje Yöneticisi onayladı</div><div class="kh-arow kh-apen">⏳ Müşteri onayı bekleniyor</div><div class="kh-arow kh-awt">… Finans kontrolü</div></div><div class="kh-cap"><span class="kh-badge">1</span><b>Onay ve yetki akışı</b></div></div><div class="kh-stage kh-s2"><div class="kh-resources"><div class="kh-res"><span class="kh-rname">Danışman A</span><div class="kh-rbar"><div class="kh-rfill" style="width:85%;background:linear-gradient(90deg,#D97757,#EBC3B0)"></div></div></div><div class="kh-res"><span class="kh-rname">Danışman B</span><div class="kh-rbar"><div class="kh-rfill" style="width:60%;background:linear-gradient(90deg,#6A9BCC,#9DC0E8)"></div></div></div><div class="kh-res"><span class="kh-rname">Hukuk Ekibi</span><div class="kh-rbar"><div class="kh-rfill" style="width:40%;background:linear-gradient(90deg,#788C5D,#A5B888)"></div></div></div><div class="kh-res"><span class="kh-rname">Analitik</span><div class="kh-rbar"><div class="kh-rfill" style="width:72%;background:linear-gradient(90deg,#141413,#6E665A)"></div></div></div></div><div class="kh-cap"><span class="kh-badge">2</span><b>Kaynak ve kapasite planlaması</b></div></div><div class="kh-stage kh-s3"><div class="kh-kgrid"><div class="kh-kpi"><span class="kh-klabel">Proje Teslim</span><div class="kh-kval">91%</div></div><div class="kh-kpi"><span class="kh-klabel">Müşteri Mem.</span><div class="kh-kval">4.7★</div></div><div class="kh-kpi"><span class="kh-klabel">Açık Proje</span><div class="kh-kval">28</div></div><div class="kh-kpi"><span class="kh-klabel">Onay Süresi</span><div class="kh-kval">1.2g</div></div></div><div class="kh-cap"><b>Kurumsal hizmetlerde şeffaf yönetim</b></div></div></div>' + '</div>';

  } else if (t === 'kobi-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.kb-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.kb-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.kb-s0{animation:kb0 10s linear infinite}.kb-s1{animation:kb1 10s linear infinite}.kb-s2{animation:kb2 10s linear infinite}.kb-s3{animation:kb3 10s linear infinite}@keyframes kb0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes kb1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes kb2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes kb3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.kb-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.kb-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600}.kb-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.kb-tools{display:flex;flex-wrap:wrap;gap:8px;max-width:300px;justify-content:center}.kb-tool{font-family:JetBrains Mono,monospace;font-size:11px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:6px;padding:8px 14px;color:#6E665A}.kb-arrow-down{font-size:36px;color:#DED9CC;margin:10px}.kb-chief-box{width:70px;height:70px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center}.kb-msg{background:#F0EDE4;border-radius:10px;padding:10px 14px;max-width:230px}.kb-msg-from{font-family:JetBrains Mono,monospace;font-size:8px;color:#A9A195;margin-bottom:4px}.kb-msg-text{font-size:12px;color:#141413;margin-bottom:8px}.kb-task-pill{background:#E2EAF2;border:1px solid #6A9BCC;border-radius:5px;padding:4px 10px;font-family:JetBrains Mono,monospace;font-size:8.5px;color:#2C5F8A;display:inline-block}.kb-growth{display:flex;flex-direction:column;align-items:center;gap:10px}.kb-bars{display:flex;align-items:flex-end;gap:5px;height:80px}.kb-gbar{width:20px;border-radius:4px 4px 0 0}.kb-grow-label{font-family:JetBrains Mono,monospace;font-size:8.5px;color:#A9A195}.kb-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.kb-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.kb-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.kb-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}' + '</style>' + '<div class="kb-wrap"><div class="kb-stage kb-s0"><div class="kb-tools"><div class="kb-tool">📧 E-posta</div><div class="kb-tool">📊 Excel</div><div class="kb-tool">💬 WhatsApp</div><div class="kb-tool">🗂️ Drive</div><div class="kb-tool">📅 Takvim</div><div class="kb-tool">📝 Not</div></div><div class="kb-arrow-down">↓</div><div class="kb-chief-box"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div><div class="kb-cap"><b>Mevcut araçları değiştirmeden tek akış</b></div></div><div class="kb-stage kb-s1"><div class="kb-msg"><div class="kb-msg-from">WhatsApp mesajı — Satış Ekibi</div><div class="kb-msg-text">"Müşteri toplantı istedi, teklif hazır mı?"</div><div class="kb-task-pill">→ Görev oluşturuldu: Teklif Hazırla</div></div><div class="kb-cap"><span class="kb-badge">1</span><b>Mesajdan göreve, göreve takibe</b></div></div><div class="kb-stage kb-s2"><div class="kb-growth"><div class="kb-bars"><div class="kb-gbar" style="height:30px;background:#E9E5D9"></div><div class="kb-gbar" style="height:42px;background:#E9E5D9"></div><div class="kb-gbar" style="height:38px;background:#E9E5D9"></div><div class="kb-gbar" style="height:55px;background:#EBC3B0"></div><div class="kb-gbar" style="height:62px;background:#D97757"></div><div class="kb-gbar" style="height:72px;background:#D97757;box-shadow:0 0 10px rgba(217,119,87,.3)"></div></div><span class="kb-grow-label">Süreç görünürlüğü arttıkça büyüme hızlanıyor</span></div><div class="kb-cap"><span class="kb-badge">2</span><b>Ölçeklenebilir süreç disiplini</b></div></div><div class="kb-stage kb-s3"><div class="kb-kgrid"><div class="kb-kpi"><span class="kb-klabel">Açık Görev</span><div class="kb-kval">47</div></div><div class="kb-kpi"><span class="kb-klabel">Takip Oranı</span><div class="kb-kval">94%</div></div><div class="kb-kpi"><span class="kb-klabel">Bekleme</span><div class="kb-kval">–62%</div></div><div class="kb-kpi"><span class="kb-klabel">Cevap Süresi</span><div class="kb-kval">1.8s</div></div></div><div class="kb-cap"><b>KOBİ\'de kurumsal süreç disiplini</b></div></div></div>' + '</div>';

  } else if (t === 'mikro-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.mk-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.mk-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.mk-s0{animation:mk0 10s linear infinite}.mk-s1{animation:mk1 10s linear infinite}.mk-s2{animation:mk2 10s linear infinite}.mk-s3{animation:mk3 10s linear infinite}@keyframes mk0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes mk1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes mk2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes mk3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.mk-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.mk-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:11px;font-weight:600}.mk-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.mk-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.mk-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.mk-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.mk-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}.mk-tools{display:flex;flex-direction:column;gap:6px;width:220px}.mk-tool{font-family:JetBrains Mono,monospace;font-size:12px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:7px;padding:10px 16px;color:#6E665A;display:flex;align-items:center;gap:8px}.mk-arrow{font-size:36px;color:#DED9CC;text-align:center;margin:8px 0}.mk-chief{width:70px;height:70px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto}.mk-msg{background:#F0EDE4;border-radius:12px;padding:16px 20px;min-width:240px}.mk-msg-label{font-family:JetBrains Mono,monospace;font-size:8px;color:#D97757;margin-bottom:4px}.mk-msg-text{font-size:14px;color:#141413}.mk-task{display:inline-block;background:#E2EAF2;border:1px solid #6A9BCC;border-radius:5px;padding:3px 9px;font-family:JetBrains Mono,monospace;font-size:8.5px;color:#2C5F8A;margin-top:6px}' + '</style>' + '<div class="mk-wrap"><div class="mk-stage mk-s0"><div class="mk-tools"><div class="mk-tool">💬 WhatsApp mesajı</div><div class="mk-tool">📧 E-posta talebi</div><div class="mk-tool">📝 Not defteri</div></div><div class="mk-arrow">↓</div><div class="mk-chief"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div><div class="mk-cap"><b>Dağınık mesajlar tek akışa geliyor</b></div></div><div class="mk-stage mk-s1"><div class="mk-msg"><div class="mk-msg-label">WhatsApp — Müşteri Ahmet:</div><div class="mk-msg-text">"Teklif ne zaman gelir?"</div><div class="mk-task">→ Görev: Teklif Hazırla — 2 saat</div></div><div class="mk-cap"><span class="mk-badge">1</span><b>Mesajdan göreve otomatik</b></div></div><div class="mk-stage mk-s2"><div class="mk-kgrid"><div class="mk-kpi"><span class="mk-klabel">Açık Görev</span><div class="mk-kval">12</div></div><div class="mk-kpi"><span class="mk-klabel">Yanıt Süresi</span><div class="mk-kval">45dk</div></div><div class="mk-kpi"><span class="mk-klabel">Kayıp Talep</span><div class="mk-kval">0</div></div><div class="mk-kpi"><span class="mk-klabel">Teklif Dön.</span><div class="mk-kval">92%</div></div></div><div class="mk-cap"><b>Hiçbir talep kaybolmuyor</b></div></div><div class="mk-stage mk-s3"><div style="display:flex;align-items:flex-end;gap:8px;height:80px"><div style="width:26px;height:26px;border-radius:4px 4px 0 0;background:#E9E5D9"></div><div style="width:26px;height:38px;border-radius:4px 4px 0 0;background:#E9E5D9"></div><div style="width:26px;height:48px;border-radius:4px 4px 0 0;background:#EBC3B0"></div><div style="width:26px;height:60px;border-radius:4px 4px 0 0;background:#D97757"></div><div style="width:26px;height:74px;border-radius:4px 4px 0 0;background:#D97757;box-shadow:0 0 10px rgba(217,119,87,.35)"></div></div><span style="font-family:JetBrains Mono,monospace;font-size:8.5px;color:#A9A195;text-align:center;max-width:240px">Ekip büyüdükçe Chief daha fazla değer üretir</span><div class="mk-cap"><span class="mk-badge">3</span><b>Büyüdükçe güçlenir</b></div></div></div>' + '</div>';

  } else if (t === 'kucuk-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.kk-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.kk-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.kk-s0{animation:kk0 10s linear infinite}.kk-s1{animation:kk1 10s linear infinite}.kk-s2{animation:kk2 10s linear infinite}.kk-s3{animation:kk3 10s linear infinite}@keyframes kk0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes kk1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes kk2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes kk3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.kk-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.kk-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:11px;font-weight:600}.kk-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.kk-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.kk-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.kk-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.kk-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}.kk-pipe{display:flex;align-items:center;gap:8px}.kk-pnode{display:flex;flex-direction:column;align-items:center;gap:4px}.kk-pico{width:60px;height:60px;border-radius:14px;display:flex;align-items:center;justify-content:center}.kk-po{background:#F6E4DA;border:1.5px solid #D97757}.kk-pb{background:#E2EAF2;border:1.5px solid #6A9BCC}.kk-ps{background:#E7EADE;border:1.5px solid #788C5D}.kk-plabel{font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.kk-arr{font-size:16px;color:#DED9CC;margin-top:-14px}.kk-funnel{display:flex;flex-direction:column;gap:5px;width:220px;margin-top:4px}.kk-frow{font-family:JetBrains Mono,monospace;font-size:8.5px;display:flex;justify-content:space-between;background:#F0EDE4;border:1px solid #DED9CC;border-radius:5px;padding:5px 10px;color:#6E665A}.kk-fval{font-weight:700;color:#141413;font-size:13px}' + '</style>' + '<div class="kk-wrap"><div class="kk-stage kk-s0"><div class="kk-pipe"><div class="kk-pnode"><div class="kk-pico kk-po"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D97757" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div><span class="kk-plabel">Talep</span></div><div class="kk-arr">→</div><div class="kk-pnode"><div class="kk-pico kk-pb"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6A9BCC" stroke-width="2"><rect x="4" y="2" width="12" height="18" rx="2"/><path d="M8 7h6M8 11h6M8 15h4"/></svg></div><span class="kk-plabel">Teklif</span></div><div class="kk-arr">→</div><div class="kk-pnode"><div class="kk-pico kk-ps"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="2"><rect x="2" y="10" width="20" height="11" rx="1"/><path d="M6 10V6l4 4V6l4 4V6l4 4"/></svg></div><span class="kk-plabel">Sipariş</span></div></div><div class="kk-cap"><b>Satış ve operasyon tek akışta</b></div></div><div class="kk-stage kk-s1"><div class="kk-funnel"><div class="kk-frow"><span>Bu Hafta Teklif</span><span class="kk-fval">14</span></div><div class="kk-frow"><span>Onay Bekleyen</span><span class="kk-fval">5</span></div><div class="kk-frow"><span>Siparişe Dönen</span><span class="kk-fval">9</span></div><div class="kk-frow" style="background:#E7EADE;border-color:#788C5D"><span>Dönüşüm</span><span class="kk-fval" style="color:#5F7049">64%</span></div></div><div class="kk-cap"><span class="kk-badge">1</span><b>Satış hattı görünürlüğü</b></div></div><div class="kk-stage kk-s2"><div class="kk-kgrid"><div class="kk-kpi"><span class="kk-klabel">Teklif Dön.</span><div class="kk-kval">64%</div></div><div class="kk-kpi"><span class="kk-klabel">SLA Uyumu</span><div class="kk-kval">91%</div></div><div class="kk-kpi"><span class="kk-klabel">Açık Görev</span><div class="kk-kval">28</div></div><div class="kk-kpi"><span class="kk-klabel">Müşteri Mem.</span><div class="kk-kval">4.6★</div></div></div><div class="kk-cap"><b>Küçük ekip, büyük süreç disiplini</b></div></div><div class="kk-stage kk-s3"><div class="kk-pipe"><div class="kk-pnode"><div class="kk-pico kk-po"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#D97757" stroke-width="1.8" stroke-linecap="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div><span class="kk-plabel">Satış</span></div><div class="kk-arr">→</div><div class="kk-pnode"><div class="kk-pico kk-pb"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6A9BCC" stroke-width="1.8" stroke-linecap="round"><rect x="2" y="10" width="20" height="11" rx="1"/><path d="M6 10V6l4 4V6l4 4V6l4 4"/></svg></div><span class="kk-plabel">Operasyon</span></div><div class="kk-arr">→</div><div class="kk-pnode"><div class="kk-pico kk-ps"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#788C5D" stroke-width="1.8" stroke-linecap="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8m-4-4v4"/></svg></div><span class="kk-plabel">Finans</span></div></div><div class="kk-cap"><span class="kk-badge">3</span><b>Satıştan finansala bilgi kaybı olmadan</b></div></div></div>' + '</div>';

  } else if (t === 'orta-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.ot-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.ot-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.ot-s0{animation:ot0 10s linear infinite}.ot-s1{animation:ot1 10s linear infinite}.ot-s2{animation:ot2 10s linear infinite}.ot-s3{animation:ot3 10s linear infinite}@keyframes ot0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes ot1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes ot2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes ot3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.ot-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.ot-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:11px;font-weight:600}.ot-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.ot-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.ot-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.ot-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.ot-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}.ot-dept{display:flex;gap:8px;flex-wrap:wrap;justify-content:center;max-width:290px}.ot-d{font-family:JetBrains Mono,monospace;font-size:11px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:6px;padding:8px 12px;color:#6E665A}.ot-chief{width:70px;height:70px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:10px auto 0}.ot-flow{display:flex;align-items:center;gap:10px}.ot-fnode{display:flex;flex-direction:column;align-items:center;gap:5px}.ot-fbox{width:64px;height:56px;border-radius:10px;font-size:22px;display:flex;align-items:center;justify-content:center;font-size:18px}.ot-fb-s{background:#F6E4DA;border:1px solid #D97757}.ot-fb-o{background:#E2EAF2;border:1px solid #6A9BCC}.ot-fb-f{background:#E7EADE;border:1px solid #788C5D}.ot-flabel{font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.ot-farr{font-size:22px;color:#DED9CC;margin-top:-14px}' + '</style>' + '<div class="ot-wrap"><div class="ot-stage ot-s0"><div class="ot-dept"><div class="ot-d">Satış</div><div class="ot-d">Operasyon</div><div class="ot-d">Saha</div><div class="ot-d">Finans</div><div class="ot-d">Kalite</div><div class="ot-d">İK</div></div><div class="ot-chief"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div><div class="ot-cap"><b>6 departman, tek süreç görünürlüğü</b></div></div><div class="ot-stage ot-s1"><div class="ot-flow"><div class="ot-fnode"><div class="ot-fbox ot-fb-s">💼</div><span class="ot-flabel">Satış</span></div><div class="ot-farr">→</div><div class="ot-fnode"><div class="ot-fbox ot-fb-o">⚙️</div><span class="ot-flabel">Operasyon</span></div><div class="ot-farr">→</div><div class="ot-fnode"><div class="ot-fbox ot-fb-f">✓</div><span class="ot-flabel">Finans</span></div></div><div class="ot-cap"><span class="ot-badge">1</span><b>Süreçler arası devir teslim</b></div></div><div class="ot-stage ot-s2"><div class="ot-kgrid"><div class="ot-kpi"><span class="ot-klabel">Entegre Süreç</span><div class="ot-kval">6</div></div><div class="ot-kpi"><span class="ot-klabel">SLA Uyumu</span><div class="ot-kval">93%</div></div><div class="ot-kpi"><span class="ot-klabel">Açık Görev</span><div class="ot-kval">84</div></div><div class="ot-kpi"><span class="ot-klabel">Bilgi Kaybı</span><div class="ot-kval">–78%</div></div></div><div class="ot-cap"><b>Orta ölçekli işletmede tam koordinasyon</b></div></div><div class="ot-stage ot-s3"><div style="background:#FAF9F5;border:1px solid #DED9CC;border-radius:12px;padding:14px 20px;width:260px"><div style="font-family:JetBrains Mono,monospace;font-size:10px;color:#D97757;margin-bottom:8px">YÖNETİM BRİFİNGİ — Otomatik</div><div style="display:flex;justify-content:space-between;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195;margin-bottom:5px;padding-bottom:5px;border-bottom:1px solid #F0EDE4"><span>Açık İş</span><span style="color:#141413;font-weight:600">84 görev</span></div><div style="display:flex;justify-content:space-between;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195;margin-bottom:5px;padding-bottom:5px;border-bottom:1px solid #F0EDE4"><span>SLA Riski</span><span style="color:#D97757;font-weight:600">3 kritik</span></div><div style="display:flex;justify-content:space-between;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195"><span>Bu Hafta Kapanış</span><span style="color:#788C5D;font-weight:600">62 görev</span></div></div><div class="ot-cap"><span class="ot-badge">3</span><b>Yönetim brifingi otomatik hazır</b></div></div></div>' + '</div>';

  } else if (t === 'buyuk-anim') {
    return '<div class="panim-wrap pcl-wrap">' + '<style>' + '.bk-wrap{position:relative;width:100%;height:320px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}.bk-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}.bk-s0{animation:bk0 10s linear infinite}.bk-s1{animation:bk1 10s linear infinite}.bk-s2{animation:bk2 10s linear infinite}.bk-s3{animation:bk3 10s linear infinite}@keyframes bk0{0%,0.5%{opacity:0}3%,22%{opacity:1}25%,100%{opacity:0}}@keyframes bk1{0%,25%{opacity:0}28%,47%{opacity:1}50%,100%{opacity:0}}@keyframes bk2{0%,50%{opacity:0}53%,72%{opacity:1}75%,100%{opacity:0}}@keyframes bk3{0%,75%{opacity:0}78%,97%{opacity:1}100%{opacity:0}}.bk-cap{position:absolute;bottom:14px;left:0;right:0;text-align:center;font-family:JetBrains Mono,monospace;font-size:10px;color:#A9A195}.bk-cap b{color:#141413;font-family:Space Grotesk,system-ui;font-size:11px;font-weight:600}.bk-badge{display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:#D97757;color:#fff;font-family:JetBrains Mono,monospace;font-size:8.5px;font-weight:700;vertical-align:middle;margin-right:4px}.bk-kgrid{display:grid;grid-template-columns:1fr 1fr;gap:10px;width:280px}.bk-kpi{background:#FAFAF8;border:1px solid #E9E5D9;border-radius:10px;padding:12px 16px}.bk-klabel{font-family:JetBrains Mono,monospace;font-size:7.5px;color:#A9A195;display:block;margin-bottom:3px}.bk-kval{font-size:24px;font-weight:700;color:#141413;font-family:Space Grotesk,system-ui;letter-spacing:-1px}.bk-globe{display:flex;flex-direction:column;align-items:center;gap:8px}.bk-locations{display:flex;gap:10px}.bk-loc{font-family:JetBrains Mono,monospace;font-size:11px;background:#F0EDE4;border:1px solid #DED9CC;border-radius:6px;padding:8px 14px;color:#6E665A;display:flex;align-items:center;gap:4px}.bk-loc-dot{width:6px;height:6px;border-radius:50%;background:#D97757}.bk-chief-big{width:72px;height:72px;width:52px;height:52px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 8px rgba(217,119,87,.07),0 0 0 16px rgba(217,119,87,.03)}.bk-dash{background:#FAF9F5;border:1px solid #DED9CC;border-radius:12px;padding:14px 20px;width:260px}.bk-dash-head{font-family:JetBrains Mono,monospace;font-size:10px;color:#D97757;margin-bottom:8px}.bk-dash-row{display:flex;justify-content:space-between;font-family:JetBrains Mono,monospace;font-size:10.5px;color:#A9A195;margin-bottom:5px;border-bottom:1px solid #F0EDE4;padding-bottom:5px}.bk-dash-val{color:#141413;font-weight:600}.bk-dash-badge{display:inline-block;width:6px;height:6px;border-radius:50%;background:#D97757;margin-right:4px}.bk-dash-badge-s{background:#788C5D}' + '</style>' + '<div class="bk-wrap"><div class="bk-stage bk-s0"><div class="bk-globe"><div class="bk-locations"><div class="bk-loc"><div class="bk-loc-dot"></div>İstanbul</div><div class="bk-loc"><div class="bk-loc-dot"></div>Ankara</div><div class="bk-loc"><div class="bk-loc-dot"></div>İzmir</div><div class="bk-loc"><div class="bk-loc-dot"></div>+12</div></div><div class="bk-chief-big"><svg viewBox="0 0 140 140" width="26" height="26" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg></div></div><div class="bk-cap"><b>Çok lokasyonlu, çok sistemli tek platform</b></div></div><div class="bk-stage bk-s1"><div class="bk-dash"><div class="bk-dash-head">YÖNETİM BRİFİNGİ — Bugün</div><div class="bk-dash-row"><span><span class="bk-dash-badge"></span>Riskli İş</span><span class="bk-dash-val">7 — Müdahale gerekli</span></div><div class="bk-dash-row"><span><span class="bk-dash-badge"></span>SLA İhlali</span><span class="bk-dash-val">3 aktif</span></div><div class="bk-dash-row" style="border-bottom:none"><span><span class="bk-dash-badge bk-dash-badge-s"></span>Tamamlanan</span><span class="bk-dash-val">142 görev</span></div></div><div class="bk-cap"><span class="bk-badge">1</span><b>Yönetim brifingi otomatik hazır</b></div></div><div class="bk-stage bk-s2"><div class="bk-kgrid"><div class="bk-kpi"><span class="bk-klabel">Lokasyon</span><div class="bk-kval">15</div></div><div class="bk-kpi"><span class="bk-klabel">Aktif Sistem</span><div class="bk-kval">8</div></div><div class="bk-kpi"><span class="bk-klabel">Günlük Görev</span><div class="bk-kval">340</div></div><div class="bk-kpi"><span class="bk-klabel">Veri Güvenliği</span><div class="bk-kval">✓</div></div></div><div class="bk-cap"><b>Kurumsal ölçekte tam görünürlük</b></div></div><div class="bk-stage bk-s3"><div style="display:flex;flex-direction:column;gap:8px;width:270px"><div style="display:flex;align-items:center;gap:10px;background:#E7EADE;border:1px solid #788C5D;border-radius:8px;padding:10px 14px"><span style="font-size:18px">🔒</span><div><div style="font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600;color:#141413">On-Premise Kurulum</div><div style="font-family:JetBrains Mono,monospace;font-size:8.5px;color:#6E665A">Veri altyapınızda kalır</div></div></div><div style="display:flex;align-items:center;gap:10px;background:#F6E4DA;border:1px solid #D97757;border-radius:8px;padding:10px 14px"><span style="font-size:18px">✓</span><div><div style="font-family:Space Grotesk,system-ui;font-size:12px;font-weight:600;color:#141413">KVKK & GDPR</div><div style="font-family:JetBrains Mono,monospace;font-size:8.5px;color:#6E665A">Sertifikalandırılabilir uyumluluk</div></div></div></div><div class="bk-cap"><span class="bk-badge">3</span><b>Kurumsal güvenlik ve uyumluluk</b></div></div></div>' + '</div>';
    ...
    var stCss = '<style>'
      ...
      + '.st-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none;gap:18px;padding:20px 24px 52px}'
      ...
      + '.st-hub{width:68px;height:68px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 12px rgba(120,140,93,.08),0 0 0 24px rgba(120,140,93,.03)}'
      ...
      + '.st-pbox{width:68px;height:68px;border-radius:13px;display:flex;align-items:center;justify-content:center;border:1.5px solid #D4CFC6}'
      ...
      + '.st-kval{font-size:26px;font-weight:700;letter-spacing:-1.5px;color:#141413}'
      ...
      + '</style>';
    var stChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg>';
    var stChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg>';
    ...
    var osCss = '<style>'
      ...
      + '.os-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none;gap:18px;padding:20px 24px 52px}'
      ...
      + '.os-hub{width:68px;height:68px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 12px rgba(106,155,204,.08),0 0 0 24px rgba(106,155,204,.03)}'
      ...
      + '.os-pbox{width:68px;height:68px;border-radius:13px;display:flex;align-items:center;justify-content:center;border:1.5px solid #D4CFC6}'
      ...
      + '.os-kval{font-size:26px;font-weight:700;letter-spacing:-1.5px;color:#141413}'
      ...
      + '</style>';
    var osChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#6A9BCC" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg>';
    var osChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#6A9BCC" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#788C5D"/></svg>';
    ...
    var utkCss = '<style>'
      ...
      + '.utk-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none;gap:18px;padding:20px 24px 52px}'
      ...
      + '.utk-hub{width:68px;height:68px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 12px rgba(120,140,93,.08),0 0 0 24px rgba(120,140,93,.03)}'
      ...
      + '.utk-pbox{width:68px;height:68px;border-radius:13px;display:flex;align-items:center;justify-content:center;border:1.5px solid #D4CFC6}'
      ...
      + '.utk-kval{font-size:26px;font-weight:700;letter-spacing:-1.5px;color:#141413}'
      ...
      + '</style>';
    var utkChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#788C5D" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#D97757"/></svg>';
    var utkChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#788C5D" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#D97757"/></svg>';
    ...
    var finCss = '<style>'
      ...
      + '.fin-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none;gap:18px;padding:20px 24px 52px}'
      ...
      + '.fin-hub{width:68px;height:68px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 12px rgba(217,119,87,.08),0 0 0 24px rgba(217,119,87,.03)}'
      ...
      + '.fin-pbox{width:68px;height:68px;border-radius:13px;display:flex;align-items:center;justify-content:center;border:1.5px solid #D4CFC6}'
      ...
      + '</style>';
    var finChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#6A9BCC"/></svg>';
    var finChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#6A9BCC"/></svg>';
    ...
    var pdCss = '<style>'
      ...
      + '.pd-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none;gap:18px;padding:20px 24px 52px}'
      ...
      + '.pd-hub{width:68px;height:68px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 12px rgba(106,155,204,.08),0 0 0 24px rgba(106,155,204,.03)}'
      ...
      + '.pd-pbox{width:68px;height:68px;border-radius:13px;display:flex;align-items:center;justify-content:center;border:1.5px solid #D4CFC6}'
      ...
      + '.pd-kval{font-size:26px;font-weight:700;letter-spacing:-1.5px;color:#141413}'
      ...
      + '</style>';
    var pdChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#6A9BCC" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#D97757"/></svg>';
    var pdChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#6A9BCC" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#D97757"/></svg>';
    ...
    var ynCss = '<style>'
      ...
      // Hub stage
      + '.yn-hub{width:68px;height:68px;background:#141413;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 0 0 12px rgba(120,140,93,.08),0 0 0 24px rgba(120,140,93,.03)}'
      ...
      + '</style>';
    var ynChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#FAF9F5" stroke-width="14" stroke-linecap="round"/><circle cx="70" cy="70" r="8" fill="#D97757"/></svg>';
