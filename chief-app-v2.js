...
function renderPageAnimation(type) {
  ...
  if (t === 'signal-flow') {
    ...
    var uC = '<svg viewBox="0 0 140 140" width="28" height="28" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    ...
    var stCss = '<style>'
      ...
      + '</style>';
    var stChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    var stChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    ...
    var osCss = '<style>'
      ...
      + '</style>';
    var osChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    var osChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    ...
    var utkCss = '<style>'
      ...
      + '</style>';
    var utkChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    var utkChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    ...
    var finCss = '<style>'
      ...
      + '</style>';
    var finChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    var finChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    ...
    var pdCss = '<style>'
      ...
      + '</style>';
    var pdChiefSvg = '<svg viewBox="0 0 140 140" width="36" height="36" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
    var pdChiefSm = '<svg viewBox="0 0 140 140" width="22" height="22" fill="none"><path d="M107 39A48 48 0 1 0 107 101" stroke="#D97757" stroke-width="11" stroke-linecap="round"/><circle cx="70" cy="70" r="7" fill="#788C5D"/></svg>';
