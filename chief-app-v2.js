...
function renderPageAnimation(type) {
  ...
  if (t === 'signal-flow') {
    ...
    var uCss = '<style>'
      + '.ua-wrap{position:relative;width:100%;height:280px;background:#fff;border-radius:16px;overflow:hidden;font-family:Space Grotesk,system-ui}'
      + '.ua-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;opacity:0;pointer-events:none}'
